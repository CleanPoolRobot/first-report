...
a mesma função. Através de uma pesquisa realizada pelo grupo constatou-se que o
...
\begin{table}[h]
    ...
    \begin{tabular}{ c  p{6cm}  }
      ...
      \\ \bottomrule
    \end{tabular}
    \caption{Análise de Concorrentes \cite{pentair2012}, \cite{sodramar2016}, \cite{aquabot2016}, respectivamente.}
    \label{tbl:competitors-analysis}
  \end{center}
\end{table}
\FloatBarrier
\par
Alguns dos concorrentes pesquisados são descritos na tabela \ref{tbl:competitors-analysis}.
