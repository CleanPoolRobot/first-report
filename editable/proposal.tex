...
necessário, enviar uma resposta ao hardware (WINDOWS). Para o projeto foram
identificadas algumas bibliotecas, disponibilizadas pela comunidade que utiliza
o Raspberry. Essas bibliotecas fazem a interface entre o hardware e o middleware,
de forma que essas APIs fazem o papel do driver.
...
pela aplicação de negócio (ORACLE). O middleware fornecerá serviços base para
